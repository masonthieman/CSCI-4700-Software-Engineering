...
<div class = "row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            @date("initial_contact_required", ["id"=>"initial_contact_required" , "disabled" => "true"]) 
        </div>
    </div>
</div>
<div class="row">
...
<div class = "row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            @date("second_contact_required", ["id"=>"second_contact_required" , "disabled" => "true"]) 
        </div>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            <label>Date:</label>
            @date("second_contact_attempt_date",["id"=>"second-contact-attempt-date"]) 
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            0=> "Completed",
            1=> "Missed"
        ],["id" => "timely-inital-contact-outcome"])
        </div>
    </div>
</div>

<input name="dynamic_area_count" type="hidden" id="dynamic_area_count" value = "2"/>
<!-- Multiple entries -->
@divider
