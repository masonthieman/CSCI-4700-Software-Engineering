...
@printcheckbox($form->start_home_health, "Home Health")
    <div class="row">
        <div class="printing-col col-md-6">
                ...
                <span class="printing-span">{{$form->home_health}}</span>
        </div>
        <div class="printing-col col-md-6">
                <label>Orders</label>
    ...
    <div class="row">
            ...
            @foreach($form->tcm_home_services_hh_vendor as $tcm_home_services_hh_vendor)
                ...
                <div class="printing-col col-md-6">
                        ...
                        <span class="printing-span">{{$tcm_home_services_hh_vendor->hh_vendor_contacted}}</span>
                </div>
                <div class="printing-col col-md-6">
                        <label>Name</label>
                ...
                <div class="printing-col col-md-6">
                        ...
                        <span class="printing-span">{{$tcm_home_services_hh_vendor->hh_follow_up_date}}</span>
                </div>
...
@printcheckbox($form->start_dme, "DME")
    <div class="row">
        <div class="printing-col col-md-6">
                <label>DME</label>      
                <span class="printing-span">{{$form->dme}}</span>
        </div>
        <div class="printing-col col-md-6">
                <label>Orders</label>            
    ...
    <div class="row">
            ...
            @foreach($form->tcm_home_services_dme_vendor as $tcm_home_services_dme_vendor)
                    ...
                    <div class="printing-col col-md-6">
                            <label>Vendor Contacted</label>               
                            <span class="printing-span">{{$tcm_home_services_dme_vendor->dme_vendor_contacted}}</span>
                    </div>
                    <div class="printing-col col-md-6">
                            <label>Name</label>              
                    ...
                    <div class="printing-col col-md-6">
                            <label>Follow Up Date</label>             
                            <span class="printing-span">{{$tcm_home_services_dme_vendor->dme_follow_up_date}}</span>
                    </div>
    ...
    <div class="row">
        <div class="printing-col col-md-6">
            <div class="form-group">
                <label>PT/OT</label>             
                <span class="printing-span">{{$form->ptot}}</span>
            </div>
        </div>
        <div class="printing-col col-md-6">
            <div class="form-group">
    ...
    <div class="row">
            ...
            @foreach($form->tcm_home_services_ptot_vendor as $tcm_home_services_ptot_vendor)
                    ...
                    <div class="printing-col col-md-6">
                        <div class="form-group">
                            <label>Vendor Contacted</label>      
                            <span class="printing-span">{{$tcm_home_services_ptot_vendor->ptot_vendor_contacted}}</span>
                        </div>
                    </div>
                    <div class="printing-col col-md-6">
                        <div class="form-group">
                    ...
                    <div class="printing-col col-md-6">
                        <div class="form-group">
                            <label>Follow Up Date</label>      
                            <span class="printing-span">{{$tcm_home_services_ptot_vendor->ptot_vendor_follow_up}}</span>
                        </div>
                    </div>
...
@printcheckbox($form->start_oxygen, "Oxygen")
    ...
    <div class="row">
        <div class="printing-col col-md-6">
            <div class="form-group">
                <label>Oxygen</label>          
                <span class="printing-span">{{$form->oxygen}}</span>
            </div>
        </div>
        <div class="printing-col col-md-6">
            <div class="form-group">
    ...
    @foreach($form->tcm_home_services_oxygen_vendor as $tcm_home_services_oxygen_vendor)
        <div class="printing-col col-md-6">
           ...
           <span class="printing-span">{{ $tcm_home_services_oxygen_vendor->oxygen_vendor_date }}</span>
        </div>
    ...
    <div class="row">
        <div class="printing-col col-md-6">
            <div class="form-group">
                ...
                <span class="printing-span">{{$form->lab}}</span>
            </div>
        </div>
        <div class="printing-col col-md-6">
            <div class="form-group">
    ...
    <!-- @dynamicarea("tcm_home_services_lab_vendor", "tcm_home_services_lab_vendor", "Vendor") -->
        @foreach($form->tcm_home_services_lab_vendor as $tcm_home_services_lab_vendor)
            <div class="printing-col col-md-6">
               ...
               <span class="printing-span">{{ $tcm_home_services_lab_vendor->lab_vendor_date }}</span>
            </div>
...
@printcheckbox($form->start_other, "Other")
    ...
    <div class="row">
        <div class="printing-col col-md-6">
            <div class="form-group">
                ...
                <span class="printing-span">{{$form->other}}</span>
            </div>
        </div>
        <div class="printing-col col-md-6">
            <div class="form-group">
    ...
    @foreach($form->tcm_home_services_other_vendor as $tcm_home_services_other_vendor)
        <div class="printing-col col-md-6">
           ...
           <span class="printing-span">{{ $tcm_home_services_other_vendor->other_vendor_date }}</span>
        </div>
