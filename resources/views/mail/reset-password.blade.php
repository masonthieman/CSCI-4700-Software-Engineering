...
<title>Reset Password - Renova</title>
...
<!-- HEADER -->
<table class="head-wrap" bgcolor="#182b4a">
	<tr>
		<td></td>
		<td class="header container" >

				<div class="content">
				<table bgcolor="#182b4a">
					<tr>
						<td><img src="{{ asset("img/navbar_brand.png") }}" /></td>
						<td align="right"><h6 class="collapse">Reset Password</h6></td>
					</tr>
				</table>
				</div>
		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3>Hi, {{ $name }}</h3>
						<p class="lead">A password reset has been requested by this account.</p>
