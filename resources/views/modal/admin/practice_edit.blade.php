		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="container-fluid">
					<form action="{{ route("ajax.practice.status.set") }}" method="post" name="practice_edit_status">
						<div class="row">
							<div class="col-12">
								<h5>Change Status</h5>
							</div>
					...
					<form action="{{ route("ajax.practice.physicians.set") }}" method="post" name="practice_edit_physicians">
						@dynamicarea("edit_physicians", "physicians", "Physician")
						<div class="row">
