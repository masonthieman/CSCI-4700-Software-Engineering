	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="container-fluid">
					<?php $__env->startComponent("component.tabs", [
						...
						<?php $__env->slot("account"); ?>
							<form action="<?php echo e(route("ajax.employee.status.set")); ?>" method="post" name="employee_edit_status">
								<div class="row">
									<div class="col-12">
										<h5>Change Status</h5>
									</div>
							...
							<form action="<?php echo e(route("ajax.employee.title.set")); ?>" method="post" name="employee_edit_title">
								<div class="row">
									<div class="col-12">
										<hr>
										<h5>Change Title</h5>
								...
								<div class="row">
									<div class="col-12 form-group">
										...
										<?php
                $params     = ["title", ["data-feedback" => "employee-edit-title-feedback", "id" => "employee-edit-title"]];
                $name       = $params[0];
            ...
            ?>
							...
							<form action="<?php echo e(route("ajax.employee.password.set")); ?>" method="post" name="employee_edit_password">
								<div class="row">
									<div class="col-12">
										<hr>
							...
							<form action="<?php echo e(route("ajax.employee.manager.assign")); ?>" method="post" name="employee_assign_manager">
								<div class="row">
									<div class="col-12">
										<hr>
							...
							<form action="<?php echo e(route("ajax.employee.name.set")); ?>" method="post" name="employee_edit_name">
								<div class="row">
									<div class="col-12">
										<hr>
										<h5>Change Name</h5>
							...
							<?php if (\Illuminate\Support\Facades\Blade::check('admin')): ?>
								<form action="<?php echo e(route("ajax.employee.auth.set")); ?>" method="post" name="employee_edit_auth">
									<div class="row">
										<div class="col-12">
											<hr>
						...
						<?php $__env->slot("practices"); ?>
							...
							<form action="<?php echo e(route("ajax.employee.practice.link")); ?>" method="post" name="employee_edit_practice_link">
								<div class="row">
									<div class="col-12 form-group">
							...
							<form action="<?php echo e(route("ajax.employee.practice.unlink")); ?>" method="post" name="employee_edit_practice_unlink">
								<div class="row">
									<div class="col-12">
										<hr>
