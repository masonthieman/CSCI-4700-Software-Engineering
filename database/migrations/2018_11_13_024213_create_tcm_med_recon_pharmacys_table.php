...
class CreateTcmMedReconPharmacysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tcm_med_recon_pharmacys', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tcm_med_recon_pharmacys');
    }
}
