...
class CreatesAuditViewThatTakesCareOfNulls extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \DB::STATEMENT("
            ...
            SELECT ae.recorded, ae.uid, ae.txid, 
                    ...
                    END
                AS description,
                af.table_name, af.table_schema, af.column_name, ae.pk_vals, ae.row_op AS op, 
                CASE COALESCE(ae.old_value, '')
                    WHEN '' THEN 'Newly created'
                    ELSE ae.old_value 
                END AS old_value,
                ae.new_value
